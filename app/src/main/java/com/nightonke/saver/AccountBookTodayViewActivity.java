...
public class AccountBookTodayViewActivity extends AppCompatActivity {
        ...
        mViewPager.setMaterialViewPagerListener(new MaterialViewPager.Listener() {
            ...
            public HeaderDesign getHeaderDesign(int page) {
                return HeaderDesign.fromColorResAndDrawable(
                        Utils.GetTagColor(RecordManager.TAGS.get(page).getId()),
    ...
    private void setFonts() {
        ...
        ((TextView)findViewById(R.id.custom_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.tag_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.month_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.list_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.report_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.sync_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.settings_text)).setTypeface(Utils.GetTypeface());
        ((TextView)findViewById(R.id.help_text)).setTypeface(Utils.GetTypeface());
    }
